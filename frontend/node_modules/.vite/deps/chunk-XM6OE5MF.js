...
function c(e8, u5, c10, i5) {
  var l6 = this, a5 = (0, import_react17.useRef)(null), o5 = (0, import_react17.useRef)(0), f2 = (0, import_react17.useRef)(0), v3 = (0, import_react17.useRef)(null), d5 = (0, import_react17.useRef)([]), s6 = (0, import_react17.useRef)(), m3 = (0, import_react17.useRef)(), h2 = (0, import_react17.useRef)(e8), g2 = (0, import_react17.useRef)(true), x3 = (0, import_react17.useRef)(), E4 = (0, import_react17.useRef)();
  h2.current = e8;
  var b5 = "undefined" != typeof window, p4 = !u5 && 0 !== u5 && b5;
  if ("function" != typeof e8) throw new TypeError("Expected a function");
  u5 = +u5 || 0;
  var y5 = !!(c10 = c10 || {}).leading, w3 = !("trailing" in c10) || !!c10.trailing, T2 = !!c10.flushOnExit && w3, O4 = "maxWait" in c10, F2 = "debounceOnServer" in c10 && !!c10.debounceOnServer, L3 = O4 ? Math.max(+c10.maxWait || 0, u5) : null, A4 = (0, import_react17.useMemo)(function() {
    var r5 = function(r6) {
      var n7 = d5.current, t8 = s6.current;
      return d5.current = s6.current = null, o5.current = r6, f2.current = f2.current || r6, m3.current = h2.current.apply(t8, n7);
    }, n6 = function(r6, n7) {
      p4 && cancelAnimationFrame(v3.current), v3.current = p4 ? requestAnimationFrame(r6) : setTimeout(r6, n7);
    }, t7 = function(r6) {
      if (!g2.current) return false;
      var n7 = r6 - a5.current;
      return !a5.current || n7 >= u5 || n7 < 0 || O4 && r6 - o5.current >= L3;
    }, e9 = function(n7) {
      return v3.current = null, w3 && d5.current ? r5(n7) : (d5.current = s6.current = null, m3.current);
    }, c11 = function r6() {
      var c12 = Date.now();
      if (y5 && f2.current === o5.current && A5(), t7(c12)) return e9(c12);
      if (g2.current) {
        var i6 = u5 - (c12 - a5.current), l7 = O4 ? Math.min(i6, L3 - (c12 - o5.current)) : i6;
        n6(r6, l7);
      }
    }, A5 = function() {
      i5 && i5({});
      ...
      if (b5 || F2) {
        var e11, i6 = Date.now(), f3 = t7(i6);
        if (d5.current = [].slice.call(arguments), s6.current = l6, a5.current = i6, T2 && !x3.current && (x3.current = function() {
          var r6;
          "hidden" === (null == (r6 = globalThis.document) ? void 0 : r6.visibilityState) && E4.current.flush();
        }, null == (e11 = globalThis.document) || null == e11.addEventListener || e11.addEventListener("visibilitychange", x3.current)), f3) {
          if (!v3.current && g2.current) return o5.current = a5.current, n6(c11, u5), y5 ? r5(a5.current) : m3.current;
          if (O4) return n6(c11, u5), r5(a5.current);
        }
        return v3.current || n6(c11, u5), m3.current;
      }
    };
    return D2.cancel = function() {
      var r6 = v3.current;
      r6 && (p4 ? cancelAnimationFrame(v3.current) : clearTimeout(v3.current)), o5.current = 0, d5.current = a5.current = s6.current = v3.current = null, r6 && i5 && i5({});
    }, D2.isPending = function() {
      return !!v3.current;
    }, D2.flush = function() {
      return v3.current ? e9(Date.now()) : m3.current;
    }, D2;
  }, [y5, O4, u5, L3, w3, T2, p4, b5, F2, i5]);
  return E4.current = A4, (0, import_react17.useEffect)(function() {
    return g2.current = true, function() {
      var r5;
      T2 && E4.current.flush(), x3.current && (null == (r5 = globalThis.document) || null == r5.removeEventListener || r5.removeEventListener("visibilitychange", x3.current), x3.current = null), g2.current = false;
    };
  }, [T2]), A4;
}
function i2(r5, n6) {
...
function l2(n6, t7, l6) {
  var a5 = l6 && l6.equalityFn || i2, o5 = (0, import_react17.useRef)(n6), f2 = (0, import_react17.useState)({})[1], v3 = c((0, import_react17.useCallback)(function(r5) {
    o5.current = r5, f2({});
  }, [f2]), t7, l6, f2), d5 = (0, import_react17.useRef)(n6);
  return a5(d5.current, n6) || (v3(n6), d5.current = n6), [o5.current, v3];
}
...
function rgba2(r5, g2, b5, a5) {
  if (a5 <= 0) r5 = g2 = b5 = NaN;
  return new Rgb(r5, g2, b5, a5);
}
...
function hslConvert(o5) {
  ...
  o5 = o5.rgb();
  var r5 = o5.r / 255, g2 = o5.g / 255, b5 = o5.b / 255, min3 = Math.min(r5, g2, b5), max3 = Math.max(r5, g2, b5), h2 = NaN, s6 = max3 - min3, l6 = (max3 + min3) / 2;
  if (s6) {
...
function lab(l6, a5, b5, opacity) {
  return arguments.length === 1 ? labConvert(l6) : new Lab(l6, a5, b5, opacity == null ? 1 : opacity);
}
function Lab(l6, a5, b5, opacity) {
  this.l = +l6;
  this.a = +a5;
...
function cubehelixConvert(o5) {
  ...
  if (!(o5 instanceof Rgb)) o5 = rgbConvert(o5);
  var r5 = o5.r / 255, g2 = o5.g / 255, b5 = o5.b / 255, l6 = (BC_DA * b5 + ED * r5 - EB * g2) / (BC_DA + ED - EB), bl = b5 - l6, k4 = (E * (g2 - l6) - C2 * bl) / D, s6 = Math.sqrt(k4 * k4 + bl * bl) / (E * l6 * (1 - l6)), h2 = s6 ? Math.atan2(k4, bl) * degrees - 120 : NaN;
...
function exponential(a5, b5, y5) {
  return a5 = Math.pow(a5, y5), b5 = Math.pow(b5, y5) - a5, y5 = 1 / y5, function(t7) {
    return Math.pow(a5 + t7 * b5, y5);
  };
}
function hue(a5, b5) {
  var d5 = b5 - a5;
  return d5 ? linear(a5, d5 > 180 || d5 < -180 ? d5 - 360 * Math.round(d5 / 360) : d5) : constant_default(isNaN(a5) ? b5 : a5);
}
function gamma(y5) {
...
function nogamma(a5, b5) {
  var d5 = b5 - a5;
  return d5 ? linear(a5, d5) : constant_default(isNaN(a5) ? b5 : a5);
}
...
function numberArray_default(a5, b5) {
  if (!b5) b5 = [];
  var n6 = a5 ? Math.min(b5.length, a5.length) : 0, c10 = b5.slice(), i5;
  return function(t7) {
    for (i5 = 0; i5 < n6; ++i5) c10[i5] = a5[i5] * (1 - t7) + b5[i5] * t7;
    return c10;
  };
}
...
function genericArray(a5, b5) {
  var nb = b5 ? b5.length : 0, na = a5 ? Math.min(nb, a5.length) : 0, x3 = new Array(na), c10 = new Array(nb), i5;
  for (i5 = 0; i5 < na; ++i5) x3[i5] = value_default(a5[i5], b5[i5]);
...
function date_default(a5, b5) {
  ...
  return a5 = +a5, b5 = +b5, function(t7) {
    return d5.setTime(a5 * (1 - t7) + b5 * t7), d5;
  };
}
...
function object_default(a5, b5) {
  ...
  for (k4 in b5) {
    if (k4 in a5) {
      i5[k4] = value_default(a5[k4], b5[k4]);
    } else {
      c10[k4] = b5[k4];
    }
  }
...
function round_default(a5, b5) {
  return a5 = +a5, b5 = +b5, function(t7) {
    return Math.round(a5 * (1 - t7) + b5 * t7);
  };
}
...
function decompose_default(a5, b5, c10, d5, e8, f2) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a5 * a5 + b5 * b5)) a5 /= scaleX, b5 /= scaleX;
  if (skewX = a5 * c10 + b5 * d5) c10 -= a5 * skewX, d5 -= b5 * skewX;
  if (scaleY = Math.sqrt(c10 * c10 + d5 * d5)) c10 /= scaleY, d5 /= scaleY, skewX /= scaleY;
  if (a5 * d5 < b5 * c10) a5 = -a5, b5 = -b5, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e8,
    translateY: f2,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a5, b5, s6, q) {
    if (a5 !== b5) {
      if (a5 - b5 > 180) b5 += 360;
      else if (b5 - a5 > 180) a5 += 360;
      q.push({ i: s6.push(pop(s6) + "rotate(", null, degParen) - 2, x: number_default(a5, b5) });
    } else if (b5) {
      s6.push(pop(s6) + "rotate(" + b5 + degParen);
    }
  }
  function skewX(a5, b5, s6, q) {
    if (a5 !== b5) {
      q.push({ i: s6.push(pop(s6) + "skewX(", null, degParen) - 2, x: number_default(a5, b5) });
    } else if (b5) {
  ...
  return function(a5, b5) {
    ...
    translate(a5.translateX, a5.translateY, b5.translateX, b5.translateY, s6, q);
    rotate(a5.rotate, b5.rotate, s6, q);
    skewX(a5.skewX, b5.skewX, s6, q);
    scale(a5.scaleX, a5.scaleY, b5.scaleX, b5.scaleY, s6, q);
    a5 = b5 = null;
    return function(t7) {
...
var Path = class {
  ...
  arcTo(x1, y1, x22, y22, r5) {
    ...
    if (this._x1 === null) {
      ...
      let x20 = x22 - x0, y20 = y22 - y0, l21_2 = x21 * x21 + y21 * y21, l20_2 = x20 * x20 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l6 = r5 * Math.tan((pi2 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l6 / l01, t21 = l6 / l21;
...
function arc_default() {
  ...
  arc.centroid = function() {
    var r5 = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a5 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi / 2;
    return [cos(a5) * r5, sin(a5) * r5];
  };
...
function descending_default(a5, b5) {
  return b5 < a5 ? -1 : b5 > a5 ? 1 : b5 >= a5 ? 0 : NaN;
}
...
function controlPoints(x3) {
  var i5, n6 = x3.length - 1, m3, a5 = new Array(n6), b5 = new Array(n6), r5 = new Array(n6);
  a5[0] = 0, b5[0] = 2, r5[0] = x3[0] + 2 * x3[1];
  for (i5 = 1; i5 < n6 - 1; ++i5) a5[i5] = 1, b5[i5] = 4, r5[i5] = 4 * x3[i5] + 2 * x3[i5 + 1];
  a5[n6 - 1] = 2, b5[n6 - 1] = 7, r5[n6 - 1] = 8 * x3[n6 - 1] + x3[n6];
  for (i5 = 1; i5 < n6; ++i5) m3 = a5[i5] / b5[i5 - 1], b5[i5] -= m3, r5[i5] -= m3 * r5[i5 - 1];
  a5[n6 - 1] = r5[n6 - 1] / b5[n6 - 1];
  for (i5 = n6 - 2; i5 >= 0; --i5) a5[i5] = (r5[i5] - a5[i5 + 1]) / b5[i5];
  b5[n6 - 1] = (x3[n6] + a5[n6 - 1]) / 2;
  for (i5 = 0; i5 < n6 - 1; ++i5) b5[i5] = 2 * x3[i5 + 1] - a5[i5 + 1];
  return [a5, b5];
}
...
function normalize(a5, b5) {
  return (b5 -= a5 = +a5) ? function(x3) {
    return (x3 - a5) / b5;
  } : constants(isNaN(b5) ? NaN : 0.5);
}
function clamper(a5, b5) {
  var t7;
  if (a5 > b5) t7 = a5, a5 = b5, b5 = t7;
  return function(x3) {
    return Math.max(a5, Math.min(b5, x3));
  };
}
...
var qr = function(e8) {
  var t7 = e8.children, n6 = e8.animate, o5 = void 0 === n6 || n6, i5 = e8.config, a5 = void 0 === i5 ? "default" : i5, l6 = (0, import_react18.useMemo)((function() {
    var e9 = (0, import_isString.default)(a5) ? config[a5] : a5;
    return { animate: o5, config: e9 };
  }), [o5, a5]);
  return (0, import_jsx_runtime2.jsx)(Sr.Provider, { value: l6, children: t7 });
};
var Dr = function() {
...
var Fr = function(e8) {
  var r5 = e8.children, t7 = e8.theme, n6 = e8.renderWrapper, i5 = void 0 === n6 || n6, a5 = e8.isInteractive, l6 = void 0 === a5 || a5, d5 = e8.animate, u5 = e8.motionConfig, c10 = (0, import_react18.useRef)(null);
  return (0, import_jsx_runtime2.jsx)(z, { theme: t7, children: (0, import_jsx_runtime2.jsx)(qr, { animate: d5, config: u5, children: (0, import_jsx_runtime2.jsx)(W2, { container: c10, children: (0, import_jsx_runtime2.jsxs)(Er, { condition: i5, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Ur, ref: c10 }), children: [r5, l6 && (0, import_jsx_runtime2.jsx)(M2, {})] }) }) }) });
};
var Kr = function(e8, r5) {
  return e8.width === r5.width && e8.height === r5.height;
};
var Nr = function(e8) {
  var r5 = e8.children, t7 = e8.width, n6 = e8.height, o5 = e8.onResize, i5 = e8.debounceResize, l6 = l2({ width: t7, height: n6 }, i5, { equalityFn: Kr })[0];
  return (0, import_react18.useEffect)((function() {
    null == o5 || o5(l6);
  }), [l6, o5]), (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: r5(l6) });
};
var $r = function(e8) {
  var r5 = e8.children, t7 = e8.defaultWidth, n6 = e8.defaultHeight, o5 = e8.onResize, i5 = e8.debounceResize, a5 = void 0 === i5 ? 0 : i5;
  return (0, import_jsx_runtime2.jsx)(AutoSizer, { defaultWidth: t7, defaultHeight: n6, children: function(e9) {
    ...
    return (0, import_jsx_runtime2.jsx)(Nr, { width: t8, height: n7, onResize: o5, debounceResize: a5, children: r5 });
  } });
};
function Jr(e8, r5) {
...
var at = (0, import_react18.memo)((function(e8) {
  var r5 = e8.id, t7 = e8.background, n6 = void 0 === t7 ? it.background : t7, o5 = e8.color, i5 = void 0 === o5 ? it.color : o5, a5 = e8.size, l6 = void 0 === a5 ? it.size : a5, d5 = e8.padding, u5 = void 0 === d5 ? it.padding : d5, c10 = e8.stagger, s6 = void 0 === c10 ? it.stagger : c10, f2 = l6 + u5, h2 = l6 / 2, p4 = u5 / 2;
...
var vt = (0, import_react18.memo)((function(e8) {
  var r5 = e8.id, t7 = e8.spacing, n6 = void 0 === t7 ? mt.spacing : t7, o5 = e8.rotation, i5 = void 0 === o5 ? mt.rotation : o5, a5 = e8.background, l6 = void 0 === a5 ? mt.background : a5, d5 = e8.color, u5 = void 0 === d5 ? mt.color : d5, c10 = e8.lineWidth, s6 = void 0 === c10 ? mt.lineWidth : c10, f2 = Math.round(i5) % 360, h2 = Math.abs(n6);
  f2 > 180 ? f2 -= 360 : f2 > 90 ? f2 -= 180 : f2 < -180 ? f2 += 360 : f2 < -90 && (f2 += 180);
  var p4, g2 = h2, b5 = h2;
  return 0 === f2 ? p4 = "\n                M 0 0 L " + g2 + " 0\n                M 0 " + b5 + " L " + g2 + " " + b5 + "\n            " : 90 === f2 ? p4 = "\n                M 0 0 L 0 " + b5 + "\n                M " + g2 + " 0 L " + g2 + " " + b5 + "\n            " : (g2 = Math.abs(h2 / Math.sin(ut(f2))), b5 = h2 / Math.sin(ut(90 - f2)), p4 = f2 > 0 ? "\n                    M 0 " + -b5 + " L " + 2 * g2 + " " + b5 + "\n                    M " + -g2 + " " + -b5 + " L " + g2 + " " + b5 + "\n                    M " + -g2 + " 0 L " + g2 + " " + 2 * b5 + "\n                " : "\n                    M " + -g2 + " " + b5 + " L " + g2 + " " + -b5 + "\n                    M " + -g2 + " " + 2 * b5 + " L " + 2 * g2 + " " + -b5 + "\n                    M 0 " + 2 * b5 + " L " + 2 * g2 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: g2, height: b5, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: g2, height: b5, fill: l6, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: p4, strokeWidth: s6, stroke: u5, strokeLinecap: "square" })] });
}));
var _t = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var wt = (0, import_react18.memo)((function(e8) {
  var r5 = e8.id, t7 = e8.color, n6 = void 0 === t7 ? _t.color : t7, o5 = e8.background, i5 = void 0 === o5 ? _t.background : o5, a5 = e8.size, l6 = void 0 === a5 ? _t.size : a5, d5 = e8.padding, u5 = void 0 === d5 ? _t.padding : d5, c10 = e8.stagger, s6 = void 0 === c10 ? _t.stagger : c10, f2 = l6 + u5, h2 = u5 / 2;
  return true === s6 && (f2 = 2 * l6 + 2 * u5), (0, import_jsx_runtime2.jsxs)("pattern", { id: r5, width: f2, height: f2, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f2, height: f2, fill: i5 }), (0, import_jsx_runtime2.jsx)("rect", { x: h2, y: h2, width: l6, height: l6, fill: n6 }), s6 && (0, import_jsx_runtime2.jsx)("rect", { x: 1.5 * u5 + l6, y: 1.5 * u5 + l6, width: l6, height: l6, fill: n6 })] });
}));
...
var Rt = (0, import_react18.forwardRef)((function(e8, r5) {
  var t7 = e8.width, n6 = e8.height, o5 = e8.margin, i5 = e8.defs, a5 = e8.children, l6 = e8.role, d5 = e8.ariaLabel, u5 = e8.ariaLabelledBy, c10 = e8.ariaDescribedBy, s6 = e8.isFocusable, f2 = M();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: t7, height: n6, role: l6, "aria-label": d5, "aria-labelledby": u5, "aria-describedby": c10, focusable: s6, tabIndex: s6 ? 0 : void 0, ref: r5, children: [(0, import_jsx_runtime2.jsx)(Mt, { defs: i5 }), (0, import_jsx_runtime2.jsx)("rect", { width: t7, height: n6, fill: f2.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + o5.left + "," + o5.top + ")", children: a5 })] });
}));
...
var Bt = (0, import_react18.memo)((function(e8) {
  var r5 = e8.width, t7 = e8.height, n6 = e8.axis, o5 = e8.scale, i5 = e8.value, a5 = e8.lineStyle, l6 = e8.textStyle, d5 = e8.legend, u5 = e8.legendNode, c10 = e8.legendPosition, s6 = void 0 === c10 ? "top-right" : c10, f2 = e8.legendOffsetX, h2 = void 0 === f2 ? 14 : f2, p4 = e8.legendOffsetY, g2 = void 0 === p4 ? 14 : p4, b5 = e8.legendOrientation, m3 = void 0 === b5 ? "horizontal" : b5, y5 = M(), _2 = 0, w3 = 0, k4 = 0, x3 = 0;
  if ("y" === n6 ? (k4 = o5(i5), w3 = r5) : (_2 = o5(i5), x3 = t7), d5 && !u5) {
    var O4 = (function(e9) {
      var r6 = e9.axis, t8 = e9.width, n7 = e9.height, o6 = e9.position, i6 = e9.offsetX, a6 = e9.offsetY, l7 = e9.orientation, d6 = 0, u6 = 0, c11 = "vertical" === l7 ? -90 : 0, s7 = "start";
      if ("x" === r6) switch (o6) {
        case "top-left":
          d6 = -i6, u6 = a6, s7 = "end";
          break;
        case "top":
          ...
          break;
        case "top-right":
          d6 = i6, u6 = a6, s7 = "horizontal" === l7 ? "start" : "end";
          break;
        case "right":
          d6 = i6, u6 = n7 / 2, s7 = "horizontal" === l7 ? "start" : "middle";
          break;
        case "bottom-right":
          d6 = i6, u6 = n7 - a6, s7 = "start";
          break;
        case "bottom":
          u6 = n7 + a6, s7 = "horizontal" === l7 ? "middle" : "end";
          break;
        case "bottom-left":
          u6 = n7 - a6, d6 = -i6, s7 = "horizontal" === l7 ? "end" : "start";
          break;
        case "left":
          d6 = -i6, u6 = n7 / 2, s7 = "horizontal" === l7 ? "end" : "middle";
      }
      else switch (o6) {
        case "top-left":
          d6 = i6, u6 = -a6, s7 = "start";
          break;
        case "top":
          d6 = t8 / 2, u6 = -a6, s7 = "horizontal" === l7 ? "middle" : "start";
          break;
        case "top-right":
          d6 = t8 - i6, u6 = -a6, s7 = "horizontal" === l7 ? "end" : "start";
          break;
        case "right":
          d6 = t8 + i6, s7 = "horizontal" === l7 ? "start" : "middle";
          break;
        case "bottom-right":
          d6 = t8 - i6, u6 = a6, s7 = "end";
          break;
        case "bottom":
          d6 = t8 / 2, u6 = a6, s7 = "horizontal" === l7 ? "middle" : "end";
          break;
        case "bottom-left":
          d6 = i6, u6 = a6, s7 = "horizontal" === l7 ? "start" : "end";
          break;
        case "left":
          d6 = -i6, s7 = "horizontal" === l7 ? "end" : "middle";
      }
      return { x: d6, y: u6, rotation: c11, textAnchor: s7 };
    })({ axis: n6, width: r5, height: t7, position: s6, offsetX: h2, offsetY: g2, orientation: m3 });
    u5 = (0, import_jsx_runtime2.jsx)("text", { transform: "translate(" + O4.x + ", " + O4.y + ") rotate(" + O4.rotation + ")", textAnchor: O4.textAnchor, dominantBaseline: "central", style: l6, children: d5 });
  }
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + _2 + ", " + k4 + ")", children: [(0, import_jsx_runtime2.jsx)("line", { x1: 0, x2: w3, y1: 0, y2: x3, stroke: y5.markers.lineColor, strokeWidth: y5.markers.lineStrokeWidth, style: a5 }), u5] });
}));
...
var It = function(e8) {
  var t7 = Dr(), n6 = t7.animate, i5 = t7.config, l6 = (function(e9) {
    var r5 = (0, import_react18.useRef)();
    return (0, import_react18.useEffect)((function() {
      r5.current = e9;
    }), [e9]), r5.current;
  })(e8), d5 = (0, import_react18.useMemo)((function() {
    return string_default(l6, e8);
  }), [l6, e8]), u5 = useSpring({ from: { value: 0 }, to: { value: 1 }, reset: true, config: i5, immediate: !n6 }).value;
  return to2(u5, d5);
};
...
var kn = function(e8, r5) {
  var t7, n6 = "touches" in r5 ? r5.touches[0] : r5, o5 = n6.clientX, i5 = n6.clientY, a5 = e8.getBoundingClientRect(), l6 = (t7 = void 0 !== e8.getBBox ? e8.getBBox() : { width: e8.offsetWidth || 0, height: e8.offsetHeight || 0 }).width === a5.width ? 1 : t7.width / a5.width;
  return [(o5 - a5.left) * l6, (i5 - a5.top) * l6];
};
...
var Mn = function(e8, r5, t7, n6) {
  var o5 = void 0 === n6 ? {} : n6, i5 = o5.dataKey, a5 = o5.colorKey, l6 = void 0 === a5 ? "color" : a5, d5 = o5.targetKey, u5 = void 0 === d5 ? "fill" : d5, c10 = [], s6 = {};
  return e8.length && r5.length && (c10 = [].concat(e8), r5.forEach((function(r6) {
    for (var n7, o6 = function() {
      var t8 = n7.value, o7 = t8.id, a7 = t8.match;
      if (zn(a7, r6, i5)) {
        ...
        if (d6) {
          if (On.includes(d6.type)) if ("inherit" === d6.background || "inherit" === d6.color) {
            var f2 = (0, import_get2.default)(r6, l6), h2 = d6.background, p4 = d6.color, g2 = o7;
            ...
            if (d6.colors.map((function(e9) {
              ...
              var b5 = (0, import_get2.default)(r6, l6), m3 = o7, v3 = Vr({}, d6, { colors: d6.colors.map((function(e9, r7) {
...
var g = (0, import_react19.memo)((function(t7) {
  var n6, o5 = t7.position, r5 = t7.anchor, e8 = t7.children, l6 = M(), u5 = Dr(), y5 = u5.animate, f2 = u5.config, g2 = sn(), w3 = g2[0], T2 = g2[1], C5 = (0, import_react19.useRef)(false), E4 = void 0, P3 = false, V2 = T2.width > 0 && T2.height > 0, O4 = Math.round(o5[0]), N2 = Math.round(o5[1]);
  ...
  var j4 = useSpring({ to: E4, config: f2, immediate: !y5 || P3 }), k4 = l6.tooltip;
...
var T = (0, import_react19.memo)((function(t7) {
  var i5, n6 = t7.id, o5 = t7.value, r5 = t7.format, e8 = t7.enableChip, l6 = void 0 !== e8 && e8, a5 = t7.color, c10 = t7.renderContent, s6 = M(), h2 = hn(r5);
  if ("function" == typeof c10) i5 = c10();
  else {
    var f2 = o5;
    void 0 !== h2 && void 0 !== f2 && (f2 = h2(f2)), i5 = (0, import_jsx_runtime3.jsxs)("div", { style: s6.tooltip.basic, children: [l6 && (0, import_jsx_runtime3.jsx)(w2, { color: a5, style: s6.tooltip.chip }), void 0 !== f2 ? (0, import_jsx_runtime3.jsxs)("span", { children: [n6, ": ", (0, import_jsx_runtime3.jsx)("strong", { children: "" + f2 })] }) : n6] });
  }
...
var E2 = (0, import_react19.memo)((function(t7) {
  var i5, n6 = t7.title, o5 = t7.rows, r5 = void 0 === o5 ? [] : o5, e8 = t7.renderContent, l6 = M();
  return r5.length ? (i5 = "function" == typeof e8 ? e8() : (0, import_jsx_runtime3.jsxs)("div", { children: [n6 && n6, (0, import_jsx_runtime3.jsx)("table", { style: v({}, C3, l6.tooltip.table), children: (0, import_jsx_runtime3.jsx)("tbody", { children: r5.map((function(t8, i6) {
    return (0, import_jsx_runtime3.jsx)("tr", { children: t8.map((function(t9, i7) {
      return (0, import_jsx_runtime3.jsx)("td", { style: l6.tooltip.tableCell, children: t9 }, i7);
    })) }, i6);
  })) }) })] }), (0, import_jsx_runtime3.jsx)("div", { style: l6.tooltip.container, children: i5 })) : null;
}));
E2.displayName = "TableTooltip";
var P2 = (0, import_react19.memo)((function(t7) {
  var i5 = t7.x0, o5 = t7.x1, r5 = t7.y0, e8 = t7.y1, l6 = M(), h2 = Dr(), u5 = h2.animate, y5 = h2.config, f2 = (0, import_react19.useMemo)((function() {
    return v({}, l6.crosshair.line, { pointerEvents: "none" });
  }), [l6.crosshair.line]), x3 = useSpring({ x1: i5, x2: o5, y1: r5, y2: e8, config: y5, immediate: !u5 });
...
var V = (0, import_react19.memo)((function(t7) {
  var i5, n6, o5 = t7.width, r5 = t7.height, e8 = t7.type, l6 = t7.x, a5 = t7.y;
  return "cross" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: r5 }, n6 = { x0: 0, x1: o5, y0: a5, y1: a5 }) : "top-left" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: a5 }, n6 = { x0: 0, x1: l6, y0: a5, y1: a5 }) : "top" === e8 ? i5 = { x0: l6, x1: l6, y0: 0, y1: a5 } : "top-right" === e8 ? (i5 = { x0: l6, x1: l6, y0: 0, y1: a5 }, n6 = { x0: l6, x1: o5, y0: a5, y1: a5 }) : "right" === e8 ? n6 = { x0: l6, x1: o5, y0: a5, y1: a5 } : "bottom-right" === e8 ? (i5 = { x0: l6, x1: l6, y0: a5, y1: r5 }, n6 = { x0: l6, x1: o5, y0: a5, y1: a5 }) : "bottom" === e8 ? i5 = { x0: l6, x1: l6, y0: a5, y1: r5 } : "bottom-left" === e8 ? (i5 = { x0: l6, x1: l6, y0: a5, y1: r5 }, n6 = { x0: 0, x1: l6, y0: a5, y1: a5 }) : "left" === e8 ? n6 = { x0: 0, x1: l6, y0: a5, y1: a5 } : "x" === e8 ? i5 = { x0: l6, x1: l6, y0: 0, y1: r5 } : "y" === e8 && (n6 = { x0: 0, x1: o5, y0: a5, y1: a5 }), (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [i5 && (0, import_jsx_runtime3.jsx)(P2, { x0: i5.x0, x1: i5.x1, y0: i5.y0, y1: i5.y1 }), n6 && (0, import_jsx_runtime3.jsx)(P2, { x0: n6.x0, x1: n6.x1, y0: n6.y0, y1: n6.y1 })] });
}));
...
var k2 = function(t7) {
  var i5 = (0, import_react19.useState)(N), o5 = i5[0], l6 = i5[1], a5 = (0, import_react19.useCallback)((function(t8, i6, n6) {
    var o6 = i6[0], r5 = i6[1];
    void 0 === n6 && (n6 = "top"), l6({ isVisible: true, position: [o6, r5], anchor: n6, content: t8 });
  }), [l6]), c10 = (0, import_react19.useCallback)((function(i6, n6, o6) {
    void 0 === o6 && (o6 = "top");
    var r5 = t7.current.getBoundingClientRect(), e8 = t7.current.offsetWidth, a6 = e8 === r5.width ? 1 : e8 / r5.width, c11 = "touches" in n6 ? n6.touches[0] : n6, s7 = c11.clientX, h2 = c11.clientY, u5 = (s7 - r5.left) * a6, d5 = (h2 - r5.top) * a6;
    "left" !== o6 && "right" !== o6 || (o6 = u5 < r5.width / 2 ? "right" : "left"), l6({ isVisible: true, position: [u5, d5], anchor: o6, content: i6 });
  }), [t7, l6]), s6 = (0, import_react19.useCallback)((function() {
    l6(N);
  }), [l6]);
...
var b3 = function(r5) {
  var i5 = r5.style, l6 = r5.children, c10 = s4(r5, h), f2 = i5.outlineWidth, u5 = i5.outlineColor, a5 = i5.outlineOpacity, d5 = s4(i5, m2);
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [f2 > 0 && (0, import_jsx_runtime4.jsx)(animated3.text, p2({}, c10, { style: p2({}, d5, { strokeWidth: 2 * f2, stroke: u5, strokeOpacity: a5, strokeLinejoin: "round" }), children: l6 })), (0, import_jsx_runtime4.jsx)(animated3.text, p2({}, c10, { style: d5, children: l6 }))] });
};
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    ...
    if (We(e8)) {
      ...
      if (Array.isArray(e8.modifiers)) {
        ...
        }, l6 = qe(e8.modifiers); !(o5 = l6()).done; ) u5();
  ...
  if ((0, import_isPlainObject2.default)(e8)) {
    ...
    if ((function(e9) {
      ...
      if (He(e8.scheme)) {
        ...
        var l6 = ordinal($e[e8.scheme][e8.size || 11]), a5 = function(e9) {
          return l6(n6(e9));
        };
...
var v2 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a5 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("circle", { r: o5 / 2, cx: i5 + o5 / 2, cy: n6 + o5 / 2, fill: r5, opacity: a5, strokeWidth: s6, stroke: void 0 === d5 ? "transparent" : d5, style: { pointerEvents: "none" } });
};
var u4 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a5 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                    M" + o5 / 2 + " 0\n                    L" + 0.8 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " " + o5 + "\n                    L" + 0.2 * o5 + " " + o5 / 2 + "\n                    L" + o5 / 2 + " 0\n                ", fill: r5, opacity: a5, strokeWidth: s6, stroke: void 0 === d5 ? "transparent" : d5, style: { pointerEvents: "none" } }) });
};
var p3 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a5 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("rect", { x: i5, y: n6, fill: r5, opacity: a5, strokeWidth: s6, stroke: void 0 === d5 ? "transparent" : d5, width: o5, height: o5, style: { pointerEvents: "none" } });
};
var y4 = function(e8) {
  var i5 = e8.x, n6 = e8.y, o5 = e8.size, r5 = e8.fill, l6 = e8.opacity, a5 = void 0 === l6 ? 1 : l6, c10 = e8.borderWidth, s6 = void 0 === c10 ? 0 : c10, d5 = e8.borderColor;
  return (0, import_jsx_runtime5.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime5.jsx)("path", { d: "\n                M" + o5 / 2 + " 0\n                L" + o5 + " " + o5 + "\n                L0 " + o5 + "\n                L" + o5 / 2 + " 0\n            ", fill: r5, opacity: a5, strokeWidth: s6, stroke: void 0 === d5 ? "transparent" : d5, style: { pointerEvents: "none" } }) });
...
var A3 = function(t7) {
  var e8, i5 = t7.direction, n6 = t7.itemsSpacing, o5 = t7.padding, r5 = t7.itemCount, l6 = t7.itemWidth, a5 = t7.itemHeight;
  ...
  var c10 = "number" == typeof o5 ? { top: o5, right: o5, bottom: o5, left: o5 } : b4({}, S2, o5), s6 = c10.left + c10.right, d5 = c10.top + c10.bottom, h2 = l6 + s6, g2 = a5 + d5, m3 = (r5 - 1) * n6;
  return "row" === i5 ? h2 = l6 * r5 + m3 + s6 : "column" === i5 && (g2 = a5 * r5 + m3 + d5), { width: h2, height: g2, padding: c10 };
};
var C4 = function(t7) {
  var e8 = t7.anchor, i5 = t7.translateX, n6 = t7.translateY, o5 = t7.containerWidth, r5 = t7.containerHeight, l6 = t7.width, a5 = t7.height, c10 = i5, s6 = n6;
  switch (e8) {
    case "top":
      c10 += (o5 - l6) / 2;
      break;
    case "top-right":
      ...
      break;
    case "right":
      c10 += o5 - l6, s6 += (r5 - a5) / 2;
      break;
    case "bottom-right":
      c10 += o5 - l6, s6 += r5 - a5;
      break;
    case "bottom":
      c10 += (o5 - l6) / 2, s6 += r5 - a5;
      break;
    case "bottom-left":
      s6 += r5 - a5;
      break;
...
var B2 = function(i5) {
  ...
  }, onMouseEnter: it2, onMouseLeave: nt }), l5.createElement(gt2, b4({ id: W3.id, x: rt2, y: lt, size: null != (a5 = $.symbolSize) ? a5 : V2, fill: null != (d5 = null != (m3 = W3.fill) ? m3 : W3.color) ? d5 : "black", borderWidth: null != (f2 = $.symbolBorderWidth) ? f2 : G, borderColor: null != (v3 = $.symbolBorderColor) ? v3 : _2 }, W3.hidden ? et.legends.hidden.symbol : void 0)), (0, import_jsx_runtime5.jsx)(b3, { textAnchor: st2, style: b4({}, et.legends.text, { fill: null != (u5 = null != (p4 = null != (y5 = $.itemTextColor) ? y5 : H2) ? p4 : et.legends.text.fill) ? u5 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, W3.hidden ? et.legends.hidden.text : void 0), x: at2, y: ct2, children: W3.label })] });
};
var H = function(e8) {
  var i5 = e8.data, n6 = e8.x, o5 = e8.y, r5 = e8.direction, l6 = e8.padding, a5 = void 0 === l6 ? k3.padding : l6, c10 = e8.justify, s6 = e8.effects, d5 = e8.itemWidth, h2 = e8.itemHeight, g2 = e8.itemDirection, m3 = void 0 === g2 ? k3.itemDirection : g2, f2 = e8.itemsSpacing, v3 = void 0 === f2 ? k3.itemsSpacing : f2, u5 = e8.itemTextColor, p4 = e8.itemBackground, y5 = void 0 === p4 ? "transparent" : p4, b5 = e8.itemOpacity, x3 = void 0 === b5 ? 1 : b5, S3 = e8.symbolShape, C5 = e8.symbolSize, z5 = e8.symbolSpacing, W3 = e8.symbolBorderWidth, w3 = e8.symbolBorderColor, X = e8.onClick, Y = e8.onMouseEnter, O4 = e8.onMouseLeave, H2 = e8.toggleSerie, E4 = A3({ itemCount: i5.length, itemWidth: d5, itemHeight: h2, itemsSpacing: v3, direction: r5, padding: a5 }).padding, j4 = "row" === r5 ? d5 + v3 : 0, L3 = "column" === r5 ? h2 + v3 : 0;
...
var L2 = function(t7, e8) {
  var i5 = e8.data, n6 = e8.containerWidth, o5 = e8.containerHeight, r5 = e8.translateX, l6 = void 0 === r5 ? 0 : r5, a5 = e8.translateY, c10 = void 0 === a5 ? 0 : a5, s6 = e8.anchor, d5 = e8.direction, h2 = e8.padding, g2 = void 0 === h2 ? 0 : h2, v3 = e8.justify, u5 = void 0 !== v3 && v3, p4 = e8.itemsSpacing, y5 = void 0 === p4 ? 0 : p4, k4 = e8.itemWidth, x3 = e8.itemHeight, S3 = e8.itemDirection, W3 = void 0 === S3 ? "left-to-right" : S3, w3 = e8.itemTextColor, X = e8.symbolSize, Y = void 0 === X ? 16 : X, O4 = e8.symbolSpacing, B3 = void 0 === O4 ? 8 : O4, H2 = e8.theme, E4 = A3({ itemCount: i5.length, itemWidth: k4, itemHeight: x3, itemsSpacing: y5, direction: d5, padding: g2 }), L3 = E4.width, M4 = E4.height, P3 = E4.padding, F2 = C4({ anchor: s6, translateX: l6, translateY: c10, containerWidth: n6, containerHeight: o5, width: L3, height: M4 }), T2 = F2.x, V2 = F2.y, D2 = "row" === d5 ? k4 + y5 : 0, R3 = "column" === d5 ? x3 + y5 : 0;
  t7.save(), t7.translate(T2, V2), a3(t7, H2.legends.text), i5.forEach((function(e9, i6) {
    var n7, o6 = i6 * D2 + P3.left, r6 = i6 * R3 + P3.top, l7 = z4({ direction: W3, justify: u5, symbolSize: Y, symbolSpacing: B3, width: k4, height: x3 }), a6 = l7.symbolX, c11 = l7.symbolY, s7 = l7.labelX, d6 = l7.labelY, h3 = l7.labelAnchor, g3 = l7.labelAlignment;
    t7.fillStyle = null != (n7 = e9.color) ? n7 : "black", t7.fillRect(o6 + a6, r6 + c11, Y, Y), t7.textAlign = j3[h3], "central" === g3 && (t7.textBaseline = "middle"), d3(t7, b4({}, H2.legends.text, { fill: null != w3 ? w3 : H2.legends.text.fill }), String(e9.label), o6 + s7, r6 + d6);
  })), t7.restore();
};
...
//# sourceMappingURL=chunk-XM6OE5MF.js.map
