    ...
    <aside className="sidebar">
      <div className="brand">
        <div className="brand-mark">
          <img src="src/assets/moneywies-logo.png" alt="MoneyWies logo" />
        </div>
      ...
      <div style={{ marginTop: "auto", padding: "16px 10px", borderTop: "1px solid var(--paper-3)", fontSize: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 30, height: 30, borderRadius: 8, background: "var(--brand-700)", color: "#fff", display: "grid", placeItems: "center", fontSize: 12, fontWeight: 600 }}>JS</div>
